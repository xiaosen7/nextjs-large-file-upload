...
export type IWrapServerAction<T extends (...args: any) => Promise<any>> =
  SetReturnType<
    T,
    Promise<
      | {
...
export type IWrapServerActions<
  T extends Record<string, (...args: any) => Promise<any>>
> = Simplify<{
  [K in keyof T]: IWrapServerAction<T[K]>;
}>;

export type IUnwrapServerAction<T extends (...args: any) => Promise<any>> =
  SetReturnType<
    T,
